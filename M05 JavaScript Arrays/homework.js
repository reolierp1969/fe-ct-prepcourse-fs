...
function incrementarPorUno(array) {
   ...
   // Tu código:
   var miArreglo=array.map((elemento)=> {
        return elemento+1;
   });
   return miArreglo;
}
...
function agregarNumeros(arrayOfNums) {
   ...
   // Tu código:
   let sum = 0;
   let suma = arrayOfNums.forEach((elemento)=>{
         sum = sum + elemento;
   });
   return sum;
}
...
function numeroMasGrande(arrayOfNums) {
   ...
   // Tu código:
   const mayor = Math.max(...arrayOfNums);
   return mayor;
}
...
function multiplicarArgumentos() {
   ...
   if(arguments.length === 0)
    ...
    {
       let miMultiplicacion = 1;   
       for(let i = 0; i < arguments.length; i++)
       {
           miMultiplicacion*=arguments[i];
...
function empiezaConNueve(num) {
   ...
   // Tu código:
   const numeroEnCadena=num.toString();
   return numeroEnCadena.charAt(0) === '9';
}
...
function todosIguales(array) {
   ...
   // Tu código:
   let sonIguales = array.every((elemento)=>{
